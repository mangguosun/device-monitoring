...
public class SigarTools {  
    ...
    public static List<SigarInfoEntity> getJvmInfos() throws Exception {  
        ...
        jvmInfoList.add(new SigarInfoEntity(addr.getHostAddress(), "SystemIp"));  
        jvmInfoList.add(new SigarInfoEntity(addr.getHostName(), "HostName"));
        jvmInfoList.add(new SigarInfoEntity(envInfoMap.get("USERNAME"), "UserName"));  
        jvmInfoList.add(new SigarInfoEntity(envInfoMap.get("COMPUTERNAME"), "ComputerName"));  
        jvmInfoList.add(new SigarInfoEntity(envInfoMap.get("USERDOMAIN"), "ComputerDomainName"));
        jvmInfoList.add(new SigarInfoEntity(sysProps.getProperty("os.name")+" "+sysProps.getProperty("os.arch")+" "+sysProps.getProperty("os.version"), "OsDescribe"));  
        jvmInfoList.add(new SigarInfoEntity(sysProps.getProperty("os.name"), "OsName"));  
        jvmInfoList.add(new SigarInfoEntity(sysProps.getProperty("os.arch"), "OsArch"));  
        jvmInfoList.add(new SigarInfoEntity(sysProps.getProperty("os.version"), "OsVersion"));
