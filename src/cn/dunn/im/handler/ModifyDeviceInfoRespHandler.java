...
public class ModifyDeviceInfoRespHandler extends ChannelHandlerAdapter {
	@Override
	public void channelRead(ChannelHandlerContext ctx, Object msg) throws Exception {
		if (msg instanceof ModifyDeviceInfoResp) {
			ModifyDeviceInfoResp resp = (ModifyDeviceInfoResp) msg;
			if (resp.getSuccess()) {
				System.out.println("修改成功");
				ConnectConstants.LOGIN_DEVICE = resp.getDevice();
